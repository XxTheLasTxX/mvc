<h1 class="page-header">
    ...
    <?php echo $alm->id != null ? $alm->Nombre : 'Editar Registro'; ?>
</h1><h1>Editar</h1>
...
<form id="frm-productos" action="?c=Productos&a=Editar" method="post" enctype="multipart/form-data">
    
    <div class="form-group">
        <label>Codigo</label>
        <input type="text" name="id" value="<?php echo $alm->id; ?>" class="form-control" readonly="disabled" />
    </div>
